...
int main(int argc, char* argv[]) {
  ...
  std::cout << std::left << std::setw(15) << "Target (ops/s)"
            << std::setw(15) << "Actual (ops/s)"
            << std::setw(12) << "Success%"
            << std::setw(12) << "P50 (us)"
            << std::setw(12) << "P99 (us)"
            << std::setw(12) << "P999 (us)"
  ...
  for (int target : throughput_levels) {
    ...
    std::cout << std::left << std::setw(15) << target
              << std::setw(15) << static_cast<int>(stats.operations_per_second)
              << std::setw(12) << std::fixed << std::setprecision(1) << (stats.success_rate * 100)
              << std::setw(12) << static_cast<int>(stats.latency_p50_us)
              << std::setw(12) << static_cast<int>(stats.latency_p99_us)
              << std::setw(12) << static_cast<int>(stats.latency_p999_us)
              << std::endl;
  }
