...
public:
    ...
    bool IsDeSerializeError() const {
        return code() == kDeSerializeError;
    }

    // Returns true iff the status indicates a Serialize error.
    bool IsSerializeError() const {
        return code() == kSerializeError;
    }

    // Returns true iff the status indicates a Protocol error.
    bool IsProtocolError() const {
        return code() == kProtocolError;
    }
