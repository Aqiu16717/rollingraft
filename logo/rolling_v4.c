...
// --- Pink Neon 配色配置区 ---
// 1;35 是高亮粉/紫，0;35 是标准粉/紫
#define COLOR_ROLLING "\033[1;35m"  // 滚动方块：高亮粉色
#define COLOR_FIXED   "\033[0;35m"  // 固定字母：标准粉色
#define COLOR_INFO    "\033[1;36m"  // 提示文字：高亮青色 (增加对比)
#define RESET         "\033[0m"
...
int main() {
    ...
    printf("\033[?25l"); // 隐藏光标
    printf("\n" COLOR_INFO "[SYS] Rollingraft: Pink Engine Initializing..." RESET "\n\n\n");
